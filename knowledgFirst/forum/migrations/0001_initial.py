    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Novice', 'Novice'), ('Regular Contributor', 'Regular Contributor'), ('Active Participant', 'Active Participant'), ('Community Leader', 'Community Leader'), ('Superuser', 'Superuser'), ('Moderator/Administrator', 'Moderator/Administrator')], default=None, max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Sport', 'Sport'), ('Nature', 'Nature'), ('IT', 'IT'), ('Food', 'Food'), ('Fashion', 'Fashion')], max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
